...
- INT4 → INT8 improves Parakeet WER by 36% (2.89% → 1.84%) and RTF by 3.3x (0.295 → 0.089)
...
Whisper numbers from original papers (FP16 inference). *Parakeet from partial runs.
